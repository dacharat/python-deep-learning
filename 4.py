...
# โหลดภาพ jack.jpg และให้ระบบจดจำใบหน้า
person1_image = face_recognition.load_image_file("person/jack.png")
person1_face_encoding = face_recognition.face_encodings(person1_image)[0]

# โหลดภาพ messi.jpg และให้ระบบจดจำใบหน้า
person2_image = face_recognition.load_image_file("person/messi.jpg")
